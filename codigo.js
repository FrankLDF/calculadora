...
document.getElementById("pto").addEventListener("click", pto);
document.getElementById("n0").addEventListener("click", n0);
document.getElementById("nac").addEventListener("click", nac);
...
function pto() {
  let actual = document.getElementById("resultado").innerHTML;
  let sumado = document.getElementById("pto").innerHTML;
  document.getElementById("resultado").innerHTML = actual + sumado;
}
function n0() {
  let actual = document.getElementById("resultado").innerHTML;
...
//Funcion ya mejorada con la funcion eval de mas arriba
